...
#1. Modelling steps: unconstrained/grand means constrained/constrained model
#2. Multiple group RI-CLPM
#3. RI-CLPM adjusted for confounders
#Our analysis were conducted with semTools (Jorgensen et al., 2022) and lavaan (Rosseel, 2012) using R (version 4.1.2) and following the coding steps proposed by Mulder and Hamaker (2021)  https://jeroendmulder.github.io/RI-CLPM/lavaan.html
...
## 1.Modelling steps: unconstrained vs. grand means constrained; unconstrained vs. constrained model ##
...
#Example of dataset for the multigorup version of the RI-CLPM 
#lonely3+fluency
